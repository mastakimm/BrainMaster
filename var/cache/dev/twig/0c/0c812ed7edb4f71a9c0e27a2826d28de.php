...
class __TwigTemplate_f3ba9bea403b388bc83b34517a52f817 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        yield "\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\" class=\"";
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_categorie_delete', {'id': categorie.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\" class=\"{{ class }}\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ categorie.id) }}\">
    <button type=\"submit\">
        Delete
    </button>
</form>
", "categorie/_delete_form.html.twig", "/home/antoine/work/BrainMaster/BrainMaster/templates/categorie/_delete_form.html.twig");
    }
}
