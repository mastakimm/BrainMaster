...
class __TwigTemplate_1e27a66b0e65f4045ab42027ac7db909 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "    <div class=\"p-8 flex flex-col gap-12\">
        <div class=\"flex justify-between items-center\">
            <h1 class=\"text-3xl\" >Edit Categorie : ";
        // line 8
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 8, $this->source); })()), "name", [], "any", false, false, false, 8), "html", null, true);
        yield "</h1>
            <a href=\"";
        // line 9
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_categorie_index");
        yield "\" class=\"text-blue-500\">Back to list</a>
        </div>
...
";
    ...
    {
        return array (  110 => 15,  105 => 13,  98 => 9,  94 => 8,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
    <div class=\"p-8 flex flex-col gap-12\">
        <div class=\"flex justify-between items-center\">
            <h1 class=\"text-3xl\" >Edit Categorie : {{ categorie.name }}</h1>
            <a href=\"{{ path('app_categorie_index') }}\" class=\"text-blue-500\">Back to list</a>
        </div>
...
{% endblock %}
", "categorie/edit.html.twig", "/home/antoine/work/BrainMaster/BrainMaster/templates/categorie/edit.html.twig");
    }
}
