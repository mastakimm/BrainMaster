...
class __TwigTemplate_4d37c54aff8ddd70fe2527b257ce2eb6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["reponse"]) || array_key_exists("reponse", $context) ? $context["reponse"] : (function () { throw new RuntimeError('Variable "reponse" does not exist.', 12, $this->source); })()), "id", [], "any", false, false, false, 12), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>Reponse</th>
        ...
        yield "</td>
            ...
            <tr>
                <th>Reponse_expected</th>
                <td>";
        // line 20
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["reponse"]) || array_key_exists("reponse", $context) ? $context["reponse"] : (function () { throw new RuntimeError('Variable "reponse" does not exist.', 20, $this->source); })()), "reponseExpected", [], "any", false, false, false, 20)) ? ("Yes") : ("No"));
        yield "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>Reponse_expected</th>
                <td>{{ reponse.reponseExpected ? 'Yes' : 'No' }}</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "reponse/show.html.twig", "/home/antoine/work/BrainMaster/BrainMaster/templates/reponse/show.html.twig");
    }
}
